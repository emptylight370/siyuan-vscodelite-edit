...
|    `table-min`     | 表格块       | 强制使用默认列宽，无默认最小列宽    | 2.3.0    | 2.3.0    |
|      `no-tag`      | 文档或内容块 | 禁用所选范围中的段落内标签样式      | 2.3.0    | 2.3.0    |
|  `callout-error`   | 引述块       | callout❌红色                       | 2.3.1    | 2.3.1    |
|   `callout-hint`   | 引述块       | callout💡蓝色                       | 2.3.1    | 2.3.1    |
|   `callout-info`   | 引述块       | calloutℹ️白色                       | 2.3.1    | 2.3.1    |
|   `callout-note`   | 引述块       | callout📝白色                       | 2.3.1    | 2.3.1    |
| `callout-question` | 引述块       | callout❓黄色                       | 2.3.1    | 2.3.1    |
|  `callout-quote`   | 引述块       | callout📣蓝色                       | 2.3.1    | 2.3.1    |
| `callout-success`  | 引述块       | callout✅绿色                       | 2.3.1    | 2.3.1    |
|   `callout-todo`   | 引述块       | callout☑️绿色                       | 2.3.1    | 2.3.1    |
| `callout-warning`  | 引述块       | callout⚠️黄色                       | 2.3.1    | 2.3.1    |
